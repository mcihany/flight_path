...
namespace Ucus_Yolu.com.siparisyonetimi.servis {
    using System;
    ...
    public partial class Service : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback beni_kaydetOperationCompleted;
        
        private bool useDefaultCredentialsSetExplicitly;
        
        /// <remarks/>
        public Service() {
            this.Url = global::Ucus_Yolu.Properties.Settings.Default.Ucus_Yolu_com_siparisyonetimi_servis_Service;
        ...
        /// <remarks/>
        public event beni_kaydetCompletedEventHandler beni_kaydetCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/IService/beni_kaydet", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public void beni_kaydet([System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string program, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string bil_Adi, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string versiyon, out bool beni_kaydetResult, [System.Xml.Serialization.XmlIgnoreAttribute()] out bool beni_kaydetResultSpecified) {
            object[] results = this.Invoke("beni_kaydet", new object[] {
                        program,
                        bil_Adi,
                        versiyon});
            beni_kaydetResult = ((bool)(results[0]));
            beni_kaydetResultSpecified = ((bool)(results[1]));
        }
        
        /// <remarks/>
        public void beni_kaydetAsync(string program, string bil_Adi, string versiyon) {
            this.beni_kaydetAsync(program, bil_Adi, versiyon, null);
        }
        
        /// <remarks/>
        public void beni_kaydetAsync(string program, string bil_Adi, string versiyon, object userState) {
            if ((this.beni_kaydetOperationCompleted == null)) {
                this.beni_kaydetOperationCompleted = new System.Threading.SendOrPostCallback(this.Onbeni_kaydetOperationCompleted);
            }
            this.InvokeAsync("beni_kaydet", new object[] {
                        program,
                        bil_Adi,
                        versiyon}, this.beni_kaydetOperationCompleted, userState);
        }
        
        private void Onbeni_kaydetOperationCompleted(object arg) {
            if ((this.beni_kaydetCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.beni_kaydetCompleted(this, new beni_kaydetCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.18408")]
    public delegate void beni_kaydetCompletedEventHandler(object sender, beni_kaydetCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.18408")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class beni_kaydetCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal beni_kaydetCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
        
        /// <remarks/>
        public bool beni_kaydetResult {
            get {
                this.RaiseExceptionIfNecessary();
        ...
        /// <remarks/>
        public bool beni_kaydetResultSpecified {
            get {
                this.RaiseExceptionIfNecessary();
